                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6">
                                <div className="team-info-text">
                                    ...
                                    <ul>
                                        <li>Position: <span>Senior</span></li>
                                        <li>Practice Area:<span>{TeamDetails.title}</span></li>
                                        <li>Experience:<span>12 Years</span></li>
                                        <li>Address:<span>Islamabad</span></li>
                                        <li>Phone:<span>+92 568 746 987</span></li>
                                        <li>Email:<span>amarazahid921@gmail.com</span></li>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <div className="language-area ex-wiget">
                                    <h2>Language</h2>
                                    <ul>
                                        <li>Urdu(fluent), English (fluent).</li>
                                    </ul>
                                </div>
